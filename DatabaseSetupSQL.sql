...
-- Exportiere Datenbank Struktur für travel-agency-service_db
...
-- Exportiere Struktur von Tabelle travel-agency-service_db.address
...
-- Exportiere Daten aus Tabelle travel-agency-service_db.address: 4 rows
DELETE FROM `address`;
...
-- Exportiere Struktur von Tabelle travel-agency-service_db.personal_data
...
-- Exportiere Daten aus Tabelle travel-agency-service_db.personal_data: 6 rows
